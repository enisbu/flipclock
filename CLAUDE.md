...
A flip clock webapp for a phone that lives in a holder on a desk. It is looked at, never operated. SvelteKit 2 with Svelte 5, zero runtime dependencies, a small handful of source files, Node 22 LTS. Live at flip.enisdev.com.
...
- **No new dependencies** without a problem plain SvelteKit cannot solve. Zero runtime dependencies is a feature of this repo.
- **Feature scope is closed.** Settings are exactly five: 24 hour time, seconds, date, theme preset, brightness. No timers, alarms, weather, calendar, music control, accounts, sync or color pickers.
